...
const ProductModal = ({ product, isAdmin, onClose, onCommentAdded, onCommentRemoved }) => {
  ...
  const handleAddComment = async () => {
    ...
    try {
      const response = await fetch(`${import.meta.env.VITE_API_URL}/api/products/${product.id}/comments`, {
        method: "POST",
        headers: {
        ...
        <div className="p-6">
          <div className="grid md:grid-cols-2 gap-8">
            ...
            <div>
              ...
              <p className="text-4xl font-bold text-yellow-600 mb-6">${product.price}</p>
            ...
            {isAdmin && (
              <div className="mb-6 p-3 bg-blue-50 border border-blue-200 rounded-lg">
                <p className="text-blue-700 text-sm">
                  <strong>Modo Administrador:</strong> Puedes eliminar comentarios inapropiados usando el botón "Eliminar".
                </p>
              </div>
            )}
            ...
            <div className="space-y-4">
              ...
              {(!product.comments || product.comments.length === 0) && (
                <p className="text-gray-500 text-center py-4">
                  No hay comentarios aún. {!isAdmin && "¡Sé el primero en comentar!"}
                </p>
              )}
            </div>
          </div>
